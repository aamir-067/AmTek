...
const Footer = () => {
    return (
        <div className='w-full flex mt-60 justify-center items-center'>
                        ...
                        <div className="w-auto p-8">
                            <a href="#">
                                <NavLink to={""} className="inline-flex items-center">
                                    <img src="https://bafybeigj25ax2rek4dygzjd4aw6vvf4vaklfu2jtrf4hw7dmcpy5jeaeta.ipfs.dweb.link/" className="h-8 mr-3 hidden md:block" alt="Flowbite Logo" />
                                    <span className="ml-4 text-lg font-bold">AmTek</span>
                                </NavLink>
                            </a>
                        </div>
                        <div className="w-auto p-8 hidden lg:block">
                            <ul className="-m-5 flex flex-wrap items-center">
                                <li className="p-5">
                                    <a target='_blank' className="font-medium text-gray-600 hover:text-gray-700" href="https://portfolio-of-aamir.netlify.app">
                                        Developer Portfolio
                                    </a>
                                </li>
                                <li className="p-5">
                                    <a target='_blank' className="font-medium text-gray-600 hover:text-gray-700" href="https://opensea.io/collection/doodles-official">
                                        View on Opensea
                                    </a>
                                </li>
                                <li className="p-5">
