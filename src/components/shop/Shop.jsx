        ...
        <div className='w-full mt-10'>
            <div className='w-full flex flex-col justify-between items-center'>
                ...
                <div className='w-6/12 mx-4 flex flex-col justify-center items-center'>
                    ...
                    <button className='text-white my-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-10 py-4 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>Mint Now</button>
                </div>
            </div>
